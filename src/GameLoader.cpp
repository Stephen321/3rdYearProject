...
void GameLoader::loadData(MapLoader * ml, Pathfinder * pf){
	...
	++texturesIT;
	ptr->menuLetterM.loadFromFile(m_filePath + imagesPath + texturesIT->value.GetString());
	++texturesIT;
	ptr->menuLetterA.loadFromFile(m_filePath + imagesPath + texturesIT->value.GetString());
	++texturesIT;
	ptr->menuLetterL1.loadFromFile(m_filePath + imagesPath + texturesIT->value.GetString());
	++texturesIT;
	ptr->menuLetterE1.loadFromFile(m_filePath + imagesPath + texturesIT->value.GetString());
	++texturesIT;
	ptr->menuLetterV.loadFromFile(m_filePath + imagesPath + texturesIT->value.GetString());
	++texturesIT;
	ptr->menuLetterO.loadFromFile(m_filePath + imagesPath + texturesIT->value.GetString());
	++texturesIT;
	ptr->menuLetterL2.loadFromFile(m_filePath + imagesPath + texturesIT->value.GetString());
	++texturesIT;
	ptr->menuLetterE2.loadFromFile(m_filePath + imagesPath + texturesIT->value.GetString());
	++texturesIT;
	ptr->menuLetterN.loadFromFile(m_filePath + imagesPath + texturesIT->value.GetString());
	++texturesIT;
	ptr->menuLetterC.loadFromFile(m_filePath + imagesPath + texturesIT->value.GetString());
	++texturesIT;
	ptr->menuLetterE3.loadFromFile(m_filePath + imagesPath + texturesIT->value.GetString());
	++texturesIT;
